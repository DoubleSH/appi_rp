...
class AccountMenu extends React.Component {
                ...
                [
                    {
                        ...
                        number: 123123,
                        dialog: [
                            {type: 0, text: 'Не могу купить дом фхфхфхф хфххфхфх ххфхфхх фххф хфххфхфх фхфхф хфх ф фххф', time: '01.07.2020 | 21:00'},
            ...
            questData: [
                {
                    title: 'Фруктовый вор', subtitle: '3 задания', done: true, tasks: [
                        {title: 'Кража апельсинов', text: 'Украсть 2 кг апельсин', reward: 'Отсутствует', complete: 0},
                ...
                },
                {
                    title: 'Фруктовый вор', subtitle: '3 задания', tasks: [
                        {title: 'Кража апельсинов', text: 'Украсть 2 кг апельсин', reward: '$ 5 000', complete: 1},
                        {title: 'Кража ананасов', text: 'Украсть 5 кг ананасов', reward: '$ 1 000', complete: 1},
                        {title: 'Кража ананасов', text: 'Украсть 5 кг ананасов', reward: '$ 1 000', complete: 2},
                        {title: 'Кража арбузов', text: 'Украсть 10 кг арбузов', reward: '$ 500', complete: 2}
                    ]
    ...
    componentDidCatch(error, errorInfo) {
        mp.trigger('client:ui:debug', 'AccountMenu.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
    }
