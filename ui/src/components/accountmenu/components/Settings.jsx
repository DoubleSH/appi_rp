...
const Settings = ({ data, activeData }) => {
    ...
    return (
        <React.Fragment>
            <div className="accountmenu__content__cards__item accountmenu__scrollable" style={{height: '97%'}}>
                <div className="accountmenu__content__cards__settings__container" style={{paddingRight: '17px'}}>
            ...
            <div className="accountmenu__content__cards__blitem__settings__buttons__container accountmenu__scrollable">
                <div className="accountmenu__content__cards__settings__container" style={{marginTop: '10px'}}>
