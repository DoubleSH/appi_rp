    ...
    const questions = [
        {
            ...
            answer: `
                ...
                <ol>
                <li class="accountmenu__content__cards__answer__li">Наш сайт: appi-rp.ru</li>
                <li class="accountmenu__content__cards__answer__li">Наш VK: vk.com/gta_5</li>
                </ol>
            `
        },
        {
...
<br><br>
        ...
        },
        {
            ...
            answer: `
                <p class="accountmenu__content__cards__answer__text">
                    Донат-услугами можно воспользоваться в разделе "Донат" на сайте appi-rp.ru
                </p>
            `
        },
        {
            ...
            answer: `
                <p class="accountmenu__content__cards__answer__text">
                    Жалобу на игрока или администратора Вы можете оставить на сайте <a>appi-rp.ru</a> в разделе "Жалоба".
                </p>
            `
        },
        {
            ...
            answer: `
                <p class="accountmenu__content__cards__answer__text">
                   Всего существует 10 слотов под транспортные средства. Вы можете иметь до 5 машин без дома, остальные 5 слотов приобретаются на сайте <a>appi-rp.ru</a> в разделе "Донат".
                </p>
                <br><br>
        ...
        },
        {
            ...
            answer: `
                <p class="accountmenu__content__cards__answer__text">
                    Почаще бегайте, деритесь, стреляйтесь или плавайте. Если хотите прокачать навыки сразу, то можете приобрести соответствую услугу в разделе "Донат" на сайте appi-rp.ru.
                </p>
            `
        },
        {
    ...
    return (
        <React.Fragment>
            <div className="accountmenu__content__cards__litem question">
                <div className="accountmenu__content__cards__container_ask" style={{height: '100%'}}>
                    <span className="accountmenu__content__cards__title_single">
                        Часто задаваемые вопросы
                    </span>
                    <div className="accountmenu__cards__question__container  accountmenu__scrollable" style={{height: '97%', marginTop: '2%'}}>
            ...
            <div className="accountmenu__content__cards__bitem accountmenu__scrollable" style={{marginTop: '3%'}}>
                <div className="accountmenu__content__cards__container_answer">
                    <div
            ...
            <div className="accountmenu__content__cards__sitem accountmenu__scrollable" style={{marginTop: '3%'}}>
                <div className="accountmenu__content__cards__container__help">
                    <span className="accountmenu__content__cards__title_heavy">
                    Если вы не нашли ответ на свой вопрос, вы можете связаться с администрацией
                    </span>
                    <div className='accountmenu__content___help__button_container'>
