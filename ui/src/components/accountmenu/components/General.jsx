        ...
        <React.Fragment>
            <div className="accountmenu__content__cards__item">
                <div className="accountmenu__content__cards__finance">
                    <span className="accountmenu__content__cards__title_medium" style={{marginTop: '1%'}}>
                        Финансы
                    </span>
                ...
                <div className="accountmenu__cards__btnreports__container">
                    <span className="accountmenu__content__cards__medicine__text">Связь с администрацией</span>
                    <div className="accountmenu__cards__btnreports">
                        <div style={{width: '48%'}}>
                            <BigButton text="Пожаловаться" type={3} onPress={() => setActivePage('accmenu-reports', 1)} />
                        </div>
                        <div style={{width: '48%', marginLeft: '1.5rem'}}>
                            <BigButton text="Спросить" type={4} onPress={() => setActivePage('accmenu-reports', 0)} />
                        </div>
                    </div>
                </div>
            ...
            <div className="accountmenu__content__cards__item accountmenu__scrollable">
                <div className="accountmenu__content__cards__item__general__person">
                    ...
                    <div className='accountmenu__cards__datainfo'>
                        <LineData
                            leftinfo="Пол:"
            ...
            <div className="accountmenu__content__cards__item" style={{height: '97%'}}>
                <span className="accountmenu__content__cards__title_medium" style={{paddingLeft: '2.5rem', display: 'flex', marginTop: '1%', marginBottom: '4%', justifyContent: 'flex-end'}}>
                    Статистика
                </span>
