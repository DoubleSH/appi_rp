...
class Tatoo extends React.Component {
        ...
        EventManager.addHandler('tattooshop', value => {
            if (value.type === 'show') {
                ...
                try {
                    ...
                    this.setState({backEvent: value.backEvent})
                    this.itemRefs[0].focus()
                }
                catch (e) {
    ...
    componentDidCatch(error, errorInfo) {
        mp.trigger('client:ui:debug', 'Tattoo.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
    }
    ...
    backBtn = () => {
        ...
        try {
            mp.trigger('client:shopMenu:backMenu', this.state.backEvent); // eslint-disable-line
        } catch (e) {
            console.log(e);
        }
