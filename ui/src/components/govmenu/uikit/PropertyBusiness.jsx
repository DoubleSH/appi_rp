...
const PropertyBussines = (props) => {
    // <img className="govmenu__licensegov__propertycar__img" src={`https://appi-rp.ru/client/images/cars/${props.name}_1.jpg`} />
    ...
    return (
        <React.Fragment>
            <div className="govmenu__propertygov__imgheader" style={{backgroundImage: `url('https://appi-rp.ru/client/images/mmenu/office.jpg')`}} />
                    ...
                    <div className="govmenu__propertygov__info__wrapper">
                        ...
                        <div className="accountmenu__content__cards__house__hprice__sell" style={{marginTop: 0, paddingTop: '1%', paddingBottom: '2%'}}>
                                <div className="accountmenu__content__cards__house__hprice__sell__linebtn">
                                    <img src={'https://appi-rp.ru/client/images/mmenu/all/icons/money-bag.svg'} className="accountmenu__content__cards__house__hprice__sell__icon" />
