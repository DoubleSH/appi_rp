...
export default function Header(props) {
    ...
    return (
        <div>
            <div className="mainmenu__header__container" style={{minHeight: props.banner ? '125px' : '', backgroundImage: props.banner ? `url('https://appi-rp.ru/client/images/banners/${props.banner}.png')` : ''}}>
