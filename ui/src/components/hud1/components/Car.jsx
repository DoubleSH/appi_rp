...
class Car extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        mp.trigger('client:ui:debug', 'Car.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
    }
        ...
        return (
            <React.Fragment>
                <div className="hud__speedometr"
                    style={{
                        backgroundImage: this.state.isShowSmall ? 'none' : `url('https://appi-rp.ru/client/images/icons/hud/speedometer-bg.svg')`,
                    ...
                    <img
                        src={this.state.light ? `https://appi-rp.ru/client/images/icons/hud/light_on.svg` : `https://appi-rp.ru/client/images/icons/hud/light_default_on.svg`}
                        className="hud__speedometr__light-on"
                    />
                    <img
                        src={this.state.light ? `https://appi-rp.ru/client/images/icons/hud/light_default_off.svg` : `https://appi-rp.ru/client/images/icons/hud/light_off.svg`}
                        className="hud__speedometr__light-off"
                    />
                    <img
                        src={this.state.door ? `https://appi-rp.ru/client/images/icons/hud/car_lock_off_default.svg` : `https://appi-rp.ru/client/images/icons/hud/car_lock_off.svg`}
                        className="hud__speedometr__door-on"
                    />
                    <img
                        src={this.state.door ? `https://appi-rp.ru/client/images/icons/hud/car_lock_on.svg` : `https://appi-rp.ru/client/images/icons/hud/car_lock_on_default.svg`}
                        className="hud__speedometr__door-off"
                    />
                    <img
                        src={this.state.turnLeft ? `https://appi-rp.ru/client/images/icons/hud/arrow_left_on.svg` : `https://appi-rp.ru/client/images/icons/hud/arrow_left_off.svg`}
                        className="hud__speedometr__arrow-left"
                    />
                    <img
                        src={this.state.turnRight ? `https://appi-rp.ru/client/images/icons/hud/arrow_right_on.svg` : `https://appi-rp.ru/client/images/icons/hud/arrow_right_off.svg`}
                        className="hud__speedometr__arrow-right"
                    />
                    <div className="hud__speedometr__info">
                        <div className="hud__speedometr__info__row">
                            <img
                                src={this.state.fuelType === '%' ? `https://appi-rp.ru/client/images/icons/hud/power.svg` : `https://appi-rp.ru/client/images/icons/hud/fuel.svg`}
