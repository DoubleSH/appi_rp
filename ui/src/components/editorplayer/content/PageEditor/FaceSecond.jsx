...
class FaceSecond extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        mp.trigger('client:ui:debug', 'FaceSecond.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
    }
        ...
        return (
            <React.Fragment>
                ...
                <div className="block-editor-range scroll-wrap custom-scroll">
                    <div className="header-title-editor">Нос</div>
                    ...
                    <div className="header-title-editor">Губы</div>
                    <div className="range-editor-block-big">
                ...
                <div className="buttons-wrap">
                    <Link to="/editor/editor-character/face-first" className="button">Назад</Link>
                    <div className="button" onClick={() => this.props.reset(2)}>Сброс</div>
                    <Link className="button blue" to="/editor/editor-character/face-last">
                        Далее
                    </Link>
                </div>
