...
import SliderArrowFaceLast from '../Elements/SliderArrowFaceLast';
...
class FaceLast extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        mp.trigger('client:ui:debug', 'FaceLast.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
    }
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <div className="face-last scroll-wrap custom-scroll">
                ...
                <div className="buttons-wrap">
                    <Link to="/editor/editor-character/face-second" className="button">Назад</Link>
                    <div className="button" onClick={() => this.props.reset(3)}>Сброс</div>
                    <Link className="button blue" to="/choicerole" onClick={() => this.props.saveCustomization()}>
                        Завершить
                    </Link>
                </div>
