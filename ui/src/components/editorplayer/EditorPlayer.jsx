...
class EditorPlayer extends React.Component {
    constructor(props) {
        ...
        this.state = {
            show: false,
            input_editor_face: [
                {name: 'Высота бровей', value: 0, minLabel: "Ниже", maxLabel: "Выше"},
                {name: 'Глубина бровей', value: 0, minLabel: "Меньше", maxLabel: "Больше"},
                {name: 'Высота скул', value: 0, minLabel: "Ниже", maxLabel: "Выше"},
                {name: 'Ширина скул', value: 0, minLabel: "Уже", maxLabel: "Шире"},
                {name: 'Глубина щёк', value: 0, minLabel: "Меньше", maxLabel: "Больше"},
                {name: 'Ширина челюсти', value: 0, minLabel: "Уже", maxLabel: "Шире"},
                {name: 'Форма челюсти', value: 0, minLabel: "Меньше", maxLabel: "Больше"},
                {name: 'Высота подбородка', value: 0, minLabel: "Ниже", maxLabel: "Выше"},
                {name: 'Ширина подбородка', value: 0, minLabel: "Уже", maxLabel: "Шире"},
                {name: 'Глубина подбородка', value: 0, minLabel: "Меньше", maxLabel: "Больше"},
                {name: 'Подбородочный отступ', value: 0, minLabel: "Меньше", maxLabel: "Больше"},
                {name: 'Обхват шеи', value: 0, minLabel: "Тоньше", maxLabel: "Толще"},
            ],
            input_editor_nose: [
                {name: 'Ширина носа', value: 0, minLabel: "Уже", maxLabel: "Шире"},
                {name: 'Высота носа', value: 0, minLabel: "Ниже", maxLabel: "Выше"},
                {name: 'Длина кончика носа', value: 0, minLabel: "Меньше", maxLabel: "Больше"},
                {name: 'Высота кончика носа', value: 0, minLabel: "Ниже", maxLabel: "Выше"},
                {name: 'Глубина моста носа', value: 0, minLabel: "Меньше", maxLabel: "Больше"},
                {name: 'Поломанность носа', value: 0, minLabel: "Левее", maxLabel: "Правее"},
            ],
            input_editor_eyes_lips: [
                {name: 'Эпикантус', value: 0, minLabel: "Меньше", maxLabel: "Больше"},
                {name: 'Толщина губ', value: 0, minLabel: "Альфа", maxLabel: "Бета"},
            ],
            input_editor_face_last: [
                {title: "Причёска", maxVal: 72, index_help: 1, values: ['l1', 'l2', 'l3']}, //Нужно заполнить массивы с актуальными значениями, значений в массиве должно быть такое же колличество как и значение maxVal
                {title: "Стиль причёски", maxVal: 72, index_help: 0, values: ['l1', 'l2', 'l3']}, //Нужно заполнить массивы с актуальными значениями, значений в массиве должно быть такое же колличество как и значение maxVal
                {title: "Цвет волос", maxVal: 64, index_help: 0, values: ['l1', 'l2', 'l3']}, //Нужно заполнить массивы с актуальными значениями, значений в массиве должно быть такое же колличество как и значение maxVal
                {title: "Мелирование волос", maxVal: 64, index_help: 0, values: ['l1', 'l2', 'l3']}, //Нужно заполнить массивы с актуальными значениями, значений в массиве должно быть такое же колличество как и значение maxVal
                {title: "Брови", maxVal: 31, index_help: 0, values: ['l1', 'l2', 'l3']}, //Нужно заполнить массивы с актуальными значениями, значений в массиве должно быть такое же колличество как и значение maxVal
                {title: "Цвет бровей", maxVal: 64, index_help: 0, values: ['l1', 'l2', 'l3']}, //Нужно заполнить массивы с актуальными значениями, значений в массиве должно быть такое же колличество как и значение maxVal
                {title: "Цвет глаз", maxVal: 32, index_help: 0, values: ['l1', 'l2', 'l3']}, //Нужно заполнить массивы с актуальными значениями, значений в массиве должно быть такое же колличество как и значение maxVal
                {title: "Веснушки", maxVal: 17, index_help: 0, values: ['l1', 'l2', 'l3']}, //Нужно заполнить массивы с актуальными значениями, значений в массиве должно быть такое же колличество как и значение maxVal
            ],
            cheked_sex: false,
            slider: [
                {
                ...
                {title: "Голова и тело", index_help: 10, minValue: 0, maxValue: 100, minLabel: 'Ближе к матери', maxLabel: 'Ближе к отцу'},
                {title: "Кожа", index_help: 10, minValue: 0, maxValue: 100, minLabel: 'Ближе к матери', maxLabel: 'Ближе к отцу'}
            ],
            stats_parents: [[ //22
            ...
            slider_national: [
                {
                    ...
                    desc: 'Национальность не влияет на внешность персонажа – вы сможете настроить её в следующих шагах',
                    nationality: [
                        "Абхаз",
                        "Австралиец",
                        "Австриец",
    ...
    componentDidCatch(error, errorInfo) {
        mp.trigger('client:ui:debug', 'EditorPlayer.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
    }
    ...
    onInputRangeChange(value, index) {
        this.setState({...this.state.slider[index].index_help = value}, () => this.setCustomization())
    }
                    ...
                    <Switch>
                        ...
                        <Route path="/editor/family-character">
                            <FamilyCharacter
                                ...
                                onInputRangeChange={this.onInputRangeChange.bind(this)}
                                ...
                                sliderHeadAndBody={this.state.slider[2]}
                                ...
                                sliderSkin={this.state.slider[3]}
