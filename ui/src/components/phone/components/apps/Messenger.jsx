...
class Messenger extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        mp.trigger('client:ui:debug', 'Messenger.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
    }
            ...
            <React.Fragment>
                <div className="dedbit-menu">
                    <div className="u-title">
                        <span className="u-texttittle-center">Messenger</span>
                    </div>
                            ...
                            try {
                                ...
                                return (
                                    <div className="m-box-sms" key={index}
                                        ...
                                        <img src={"https://a.rsg.sc/" + e.avatar} alt="" className="m-img-sms" />
