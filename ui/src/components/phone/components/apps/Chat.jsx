...
class Chat extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        mp.trigger('client:ui:debug', 'Chat.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
    }
                ...
                <div className="dedbit-menu">
                    <div className="u-title" style={{ height: 50 + 'px' }}>
                        <div className="dedbit-u-texttittle">
                            <img src={`https://appi-rp.ru/client/images/icons/components/phone/img/back.svg`} className="u__back-nabs" height="16" onClick={() => this.props.setLink("/phone/android/messenger")} />
