...
class Android extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            apps: [
                ...
                //{ link: "/phone/android/umenu", action: 'slafy', img: 'settings', name: 'Настройки' },
                ...
                items: [
                    {
                        ...
                        umenu: [
                            /*{
                                ...
                                text: "И описанием",
                                type: 0,
                                value: 'https://appi-rp.ru/client/images/cars/Elegy_1.png',
                                clickable: false,
                                params: { name: "null" }
                            },
                            {
    ...
    componentDidCatch(error, errorInfo) {
        mp.trigger('client:ui:debug', 'Android.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
    }
    ...
    componentDidMount() {
        EventManager.addHandler('phone3', value => {
            ...
            if (value.type === 'updateAppsBottom') {
                try {
                    this.setState({ appsBottom: value.apps });
                } catch (e) {
                    console.log(e);
                }
            }
        ...
        return (
            <React.Fragment>
                <div onContextMenu={() => this.rotateAndroid()} className={this.state.rotate ? "android-phone rotate-androind" : "android-phone"}>
                    <img className="phone__box" src={`https://appi-rp.ru/client/images/icons/components/phone/img/iphone_frame.png`} />
