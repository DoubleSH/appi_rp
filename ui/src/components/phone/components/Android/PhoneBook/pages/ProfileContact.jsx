...
class ProfileContact extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        try {
            mp.trigger('client:ui:debug', 'ProfileContact.jsx', error.toString(), errorInfo.toString()); // eslint-disable-line
        }
        catch (e) {}
    }
                    ...
                    <div className="u-title">
                        <div className="dedbit-u-texttittle">
                            <div className="u__back__container">
                                <img src={`https://appi-rp.ru/client/images/icons/components/phone/img/back.svg`} className="u__back" height="16" onClick={() => this.props.historyGoBack()} />
                            </div>
