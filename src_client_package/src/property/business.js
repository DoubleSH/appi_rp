...
business.addMoney = function(id, money, itemName = 'Операция со счетом') {
    methods.callRemote('server:business:addMoney', id, money, itemName);
};

business.removeMoney = function(id, money, itemName = 'Операция со счетом') {
    methods.callRemote('server:business:removeMoney', id, money, itemName);
};

business.setMoney = function(id, money) {
    methods.callRemote('server:business:setMoney', id, money);
};
...
business.addMoneyTax = function(id, money) {
    methods.callRemote('server:business:addMoneyTax', id, money);
};

business.removeMoneyTax = function(id, money) {
    methods.callRemote('server:business:removeMoneyTax', id, money);
};

business.setMoneyTax = function(id, money) {
    methods.callRemote('server:business:setMoneyTax', id, money);
};
...
business.save = function(id) {
    methods.callRemote('server:business:save', id);
};
