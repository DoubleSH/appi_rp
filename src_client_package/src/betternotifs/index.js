...
new_events.add("BN_Show", (message, flashing = false, textColor = -1, bgColor = -1, flashColor = [77, 77, 77, 200]) => {
...
new_events.add("BN_ShowWithPicture", async (title, sender, message, notifPic, icon = 0, flashing = false, textColor = -1, bgColor = -1, flashColor = [77, 77, 77, 200]) => {
...
new_events.add("BN_ShowWithStats", async (title = "PSF_STAMINA", lastProgress = 25, newProgress = 50) => {
