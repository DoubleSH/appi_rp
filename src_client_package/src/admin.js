...
admin.startSpectate = (remote_id) => {
    spectateTarget = mp.players.atRemoteId(remote_id)
    if(spectateTarget) spectateEnabled = true
}
...
new_events.add('render', function() {
    if(user.targetSpectate){
        return;
    }
