...
new_events.add("updatePlayerWeaponComponent", (player, weaponHash, componentHash, removeComponent) => {
    try {
...
new_events.add("resetPlayerWeaponComponents", (player, weaponHash) => {
    try {
...
new_events.add("nukePlayerWeaponComponents", (player) => {
    try {
        if (!player.hasOwnProperty("__weaponComponentData")) return;
...
new_events.add("updatePlayerWeaponTint", (entity, value) => {
    try {
...
new_events.add("entityStreamOut", (entity) => {
    try {
        if (entity.type === "player" && entity.hasOwnProperty("__weaponComponentData") && mp.players.exists(entity))
