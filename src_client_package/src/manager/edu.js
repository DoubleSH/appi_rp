...
let longPos = [
    [
        "Добро пожаловать",
        "info",
        "Добро пожаловать на Appi, уникальный Role Play сервер, где вы точно будете удивлены вашими возможностями. Скорее всего у вас возникнет вопрос что же уникального у нас есть? Тогда нажимайте далее и начинайте знакомство с нашим сервером.",
    ...
    [
        "Тюрьма",
        "info",
        "Тюрьма Болингброук является местом, где сидят свой срок простые заключённые, нарушившие закон штата San Andreas, а так же люди, нарушившие правила проекта, поэтому рекомендуем вам ознакомиться с ними более подробно",
