...
let checkShooting = function () {
    ...
    try {
        if (user.getCache('stats_shooting') < 1) {
            user.set('stats_shooting', 1);
        }
...
let updateStats = function() {
    ...
    try {
        ...
        skill.setStatInt(mp.game.joaat("SP0_TOTAL_CASH"), user.getCashMoney() + user.getBankMoney(), false);
        ...
        skill.setStatInt(mp.game.joaat("MP0_STAMINA"), user.getCache('stats_endurance'), true);
        skill.setStatInt(mp.game.joaat("MP0_STRENGTH"), user.getCache('stats_strength'), true);
        skill.setStatInt(mp.game.joaat("MP0_LUNG_CAPACITY"), user.getCache('stats_lung_capacity'), true);
        skill.setStatInt(mp.game.joaat("MP0_WHEELIE_ABILITY"), user.getCache('stats_driving'), true);
        skill.setStatInt(mp.game.joaat("MP0_STEALTH_ABILITY"), user.getCache('stats_lucky'), true);
        skill.setStatInt(mp.game.joaat("MP0_SHOOTING_ABILITY"), user.getCache('stats_shooting'), true);

        skill.setStatInt(mp.game.joaat("STAMINA"), user.getCache('stats_endurance'), true);
        skill.setStatInt(mp.game.joaat("STRENGTH"), user.getCache('stats_strength'), true);
        skill.setStatInt(mp.game.joaat("LUNG_CAPACITY"), user.getCache('stats_lung_capacity'), true);
        skill.setStatInt(mp.game.joaat("WHEELIE_ABILITY"), user.getCache('stats_driving'), true);
        skill.setStatInt(mp.game.joaat("STEALTH_ABILITY"), user.getCache('stats_lucky'), true);
        skill.setStatInt(mp.game.joaat("SHOOTING_ABILITY"), user.getCache('stats_shooting'), true);

        skill.setStatInt(mp.game.joaat("SP0_STAMINA"), user.getCache('stats_endurance'), true);
        skill.setStatInt(mp.game.joaat("SP0_STRENGTH"), user.getCache('stats_strength'), true);
        skill.setStatInt(mp.game.joaat("SP0_LUNG_CAPACITY"), user.getCache('stats_lung_capacity'), true);
        skill.setStatInt(mp.game.joaat("SP0_WHEELIE_ABILITY"), user.getCache('stats_driving'), true);
        skill.setStatInt(mp.game.joaat("SP0_STEALTH_ABILITY"), user.getCache('stats_lucky'), true);
        skill.setStatInt(mp.game.joaat("SP0_SHOOTING_ABILITY"), user.getCache('stats_shooting'), true);

        skill.setStatInt(mp.game.joaat("SP1_STAMINA"), user.getCache('stats_endurance'), true);
        skill.setStatInt(mp.game.joaat("SP1_STRENGTH"), user.getCache('stats_strength'), true);
        skill.setStatInt(mp.game.joaat("SP1_LUNG_CAPACITY"), user.getCache('stats_lung_capacity'), true);
        skill.setStatInt(mp.game.joaat("SP1_WHEELIE_ABILITY"), user.getCache('stats_driving'), true);
        skill.setStatInt(mp.game.joaat("SP1_STEALTH_ABILITY"), user.getCache('stats_lucky'), true);
        skill.setStatInt(mp.game.joaat("SP1_SHOOTING_ABILITY"), user.getCache('stats_shooting'), true);

        skill.setStatInt(mp.game.joaat("SP2_STAMINA"), user.getCache('stats_endurance'), true);
        skill.setStatInt(mp.game.joaat("SP2_STRENGTH"), user.getCache('stats_strength'), true);
        skill.setStatInt(mp.game.joaat("SP2_LUNG_CAPACITY"), user.getCache('stats_lung_capacity'), true);
        skill.setStatInt(mp.game.joaat("SP2_WHEELIE_ABILITY"), user.getCache('stats_driving'), true);
        skill.setStatInt(mp.game.joaat("SP2_STEALTH_ABILITY"), user.getCache('stats_lucky'), true);
        skill.setStatInt(mp.game.joaat("SP2_SHOOTING_ABILITY"), user.getCache('stats_shooting'), true);

        if (weather.getWindSpeed() >= 8) {
            skill.setStatInt(mp.game.joaat("MP0_FLYING_ABILITY"), 0, true);
            skill.setStatInt(mp.game.joaat("FLYING_ABILITY"), 0, true);
            skill.setStatInt(mp.game.joaat("SP0_FLYING_ABILITY"), 0, true);
            skill.setStatInt(mp.game.joaat("SP1_FLYING_ABILITY"), 0, true);
            skill.setStatInt(mp.game.joaat("SP2_FLYING_ABILITY"), 0, true);
        }
        else {
            skill.setStatInt(mp.game.joaat("MP0_FLYING_ABILITY"), user.getCache('stats_flying'), true);
            skill.setStatInt(mp.game.joaat("FLYING_ABILITY"), user.getCache('stats_flying'), true);
            skill.setStatInt(mp.game.joaat("SP0_FLYING_ABILITY"), user.getCache('stats_flying'), true);
            skill.setStatInt(mp.game.joaat("SP1_FLYING_ABILITY"), user.getCache('stats_flying'), true);
            skill.setStatInt(mp.game.joaat("SP2_FLYING_ABILITY"), user.getCache('stats_flying'), true);
        }
    }
    catch (e) {
        methods.debug(e);
...
skill.setStatInt = function(hash, val, save = true) {
    mp.game.stats.statSetInt(hash, methods.parseInt(val), save)
};

skill.loadAll = function() {
    timer.createInterval('checkStats', checkStats, 300000);
