...
lamar.finish = async function() {
    try {
        ...
        if (user.getCache('fraction_id2') > 0) {
            fraction.set(user.getCache('fraction_id2'), 'order_lamar', await fraction.get(user.getCache('fraction_id2'), 'order_lamar') + 1);
            fraction.set(user.getCache('fraction_id2'), 'order_lamar_m', await fraction.get(user.getCache('fraction_id2'), 'order_lamar_m') + 1);
        }
        ...
        setTimeout(function () {
            methods.callRemote('server:rent:buy', -1842748181, 0.1, 0);
        }, 5000);
    }
    catch (e) {
        methods.debug(e);
