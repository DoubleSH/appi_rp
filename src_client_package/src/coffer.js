...
coffer.addMoney = function(id, money) {
    methods.callRemote('server:coffer:addMoney', id, money);
};

coffer.removeMoney = function(id, money) {
    methods.callRemote('server:coffer:removeMoney', id, money);
};

coffer.setMoney = function(id, money) {
    methods.callRemote('server:coffer:setMoney', id, money);
};
