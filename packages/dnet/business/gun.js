...
gun.getInRadius = function (pos, radius = 2) {
    methods.debug('gun.getInRadius', pos, radius);
    let shopId = -1;
...
gun.findNearest = function (pos) {
    methods.debug('gun.findNearest', pos);
...
gun.buy = function (player, itemId, price, count, superTint, tint, shopId, payType) {
    methods.debug('gun.buy', itemId, price, count, superTint, tint, shopId, payType);
    ...
    setTimeout(() => {
        ...
        methods.debug('gun.buy.setTimeout');
