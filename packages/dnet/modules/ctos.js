...
ctos.setRadioBlackout = function(player) {
    methods.debug('ctos.setRadioBlackout');
    let nearIdx = -1;
...
ctos.setRadioNetwork = function(player) {
    methods.debug('ctos.setRadioNetwork');
    let nearIdx = -1;
    let pos = player.position;
...
ctos.canBlackout = function() {
    methods.debug('ctos.canBlackout');
...
ctos.setBlackout = function (enable) {
    methods.debug('ctos.setBlackout', enable);
    isBlackout = enable;
...
ctos.setNoNetwork = function (enable) {
    methods.debug('ctos.setNoNetwork', enable);
    isNetwork = enable;
