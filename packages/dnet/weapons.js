...
weapons.hashesMap = [
    ["weapon_dagger", -1834847097, -1, -1],
    ["weapon_bat", -1786099057, -1, -1],
    ["weapon_bottle", -102323637, -1, -1],
    ["weapon_crowbar", -2067956739, -1, -1],
    ["weapon_unarmed", -1569615261, -1, -1],
    ["weapon_flashlight", -1951375401, -1, -1],
    ["weapon_golfclub", 1141786504,-1, -1],
    ["weapon_hammer", 1317494643, -1, -1],
    ["weapon_hatchet", -102973651, -1, -1],
    ["weapon_knuckle", -656458692, -1, -1],
    ["weapon_knife", -1716189206, -1, -1],
    ["weapon_machete", -581044007, -1, -1],
    ["weapon_switchblade", -538741184, -1, -1],
    ["weapon_nightstick", 1737195953, -1, -1],
    ["weapon_wrench", 419712736, -1, -1],
    ["weapon_battleaxe", -853065399, -1, -1],
    ["weapon_poolcue", -1810795771, -1, -1],
    ["weapon_stone_hatchet", 940833800, -1, -1],

    ["weapon_pistol", 453432689, 15, 25], //4
    ["weapon_pistol_mk2", -1075685676, 20, 30], //5-7
    ["weapon_combatpistol", 1593441988, 15, 25], //5-7
    ["weapon_appistol", 584646201, 7, 10], //5-7
    ["weapon_stungun", 911657153, -1, -1],
    ["weapon_pistol50", -1716589765, 25, 40], //10
    ["weapon_snspistol", -1076751822, 5, 10], //3
    ["weapon_snspistol_mk2", -2009644972, 7, 14], //4
    ["weapon_heavypistol", -771403250, 20, 30], //10
    ["weapon_vintagepistol", 137902532, 5, 10], //7
    ["weapon_flaregun", 1198879012, -1, -1],
    ["weapon_marksmanpistol", -598887786, 50, 90], //70
    ["weapon_revolver", -1045183535, 35, 45], //50хп
    ["weapon_revolver_mk2", -879347409, 50, 70], //50хп
    ["weapon_doubleaction", -1746263880, 30, 40], //
    ["weapon_raypistol", -1355376991, 0, 0],
    ["weapon_ceramicpistol", 727643628, 20, 30],
    ["weapon_navyrevolver", -1853920116, 35, 45],
    ["weapon_microsmg", 324215364, 10, 15],
    ["weapon_smg", 736523883, 12, 17],
    ["weapon_smg_mk2", 2024373456, 12, 17],
    ["weapon_assaultsmg", -270015777, 15, 20],
    ["weapon_combatpdw", 171789620, 12, 17],
    ["weapon_machinepistol", -619010992, 10, 15],
    ["weapon_minismg", -1121678507, 10, 15],
    ["weapon_raycarbine", 1198256469, 0, 0],
    ["weapon_pumpshotgun", 487013001, 5, 10],
    ["weapon_pumpshotgun_mk2", 1432025498, 8, 13],
    ["weapon_sawnoffshotgun", 2017895192, 4, 9],
    ["weapon_assaultshotgun", -494615257, 5, 10],
    ["weapon_bullpupshotgun", -1654528753, 5, 10],
    ["weapon_musket", -1466123874, 50, 70],
    ["weapon_heavyshotgun", 984333226, 20, 35],
    ["weapon_dbshotgun", -275439685, 5, 7],
    ["weapon_autoshotgun", 317205821, 6, 11],
    ["weapon_assaultrifle", -1074790547, 14, 18],
    ["weapon_assaultrifle_mk2", 961495388, 18, 23],
    ["weapon_carbinerifle", -2084633992, 14, 18],
    ["weapon_carbinerifle_mk2", -86904375, 18, 23],
    ["weapon_advancedrifle", -1357824103, 15, 19],
    ["weapon_specialcarbine", -1063057011, 14, 18],
    ["weapon_specialcarbine_mk2", -1768145561, 18, 23],
    ["weapon_bullpuprifle", 2132975508, 13, 17],
    ["weapon_bullpuprifle_mk2", -2066285827, 17, 22],
    ["weapon_compactrifle", 1649403952, 12, 16],
    ["weapon_mg", -1660422300, 14, 18],
    ["weapon_combatmg", 2144741730, 14, 18],
    ["weapon_combatmg_mk2", -608341376, 15, 20],
    ["weapon_gusenberg", 1627465347, 10, 15],
    ["weapon_sniperrifle", 100416529, 50, 70],
    ["weapon_heavysniper", 205991906, 100, 200],
    ["weapon_heavysniper_mk2", 177293209, 150, 1000],
    ["weapon_marksmanrifle", -952879014, 30, 45],
    ["weapon_marksmanrifle_mk2", 1785463520, 40, 55],
    ["weapon_rpg", -1312131151, -100, -100],
    ["weapon_grenadelauncher", -1568386805, 0, 0],
    ["weapon_grenadelauncher_smoke", 1305664598, 0, 0],
    ["weapon_minigun", 1119849093, -100, -100],
    ["weapon_firework", 2138347493, 0, 0],
    ["weapon_railgun", 1834241177, 0, 0],
    ["weapon_hominglauncher", 1672152130, 0, 0],
    ["weapon_compactlauncher", 125959754, 0, 0],
    ["weapon_rayminigun", -1238556825, 0, 0],
    ["weapon_grenade", -1813897027, 0, 0],
    ["weapon_bzgas", -1600701090, 0, 0],
    ["weapon_smokegrenade", -37975472, 0, 0],
    ["weapon_flare", 1233104067, 0, 0],
    ["weapon_molotov", 615608432, 0, 0],
    ["weapon_stickybomb", 741814745, 0, 0],
    ["weapon_proxmine", -1420407917, 0, 0],
    ["weapon_snowball", 126349499, 0, 0],
    ["weapon_pipebomb", -1169823560, 0, 0],
    ["weapon_ball", 600439132, 0, 0],
    ["weapon_petrolcan", 883325847, 0, 0],
    ["weapon_fireextinguisher", 101631238, 0, 0],
    ["weapon_parachute", -196322845, 0, 0],
    ["weapon_hazardcan", -1168940174, 0, 0],
];
...
weapons.getHashByName = function(name) {
    methods.debug('weapons.getHashByName')
    let hash = 0;
...
weapons.getHashByInt64 = function(int64) {
    methods.debug('weapons.getHashByInt64')
    let hash = 0;
    weapons.hashesMap.forEach(item => {
...
weapons.getWeaponComponentHashName = function(weaponName, hash) {
    methods.debug('weapons.getWeaponComponentHashName')
    let component = '';
...
weapons.getUpgradeSlot = function(weaponName, hash) {
    methods.debug('weapons.getUpgradeSlot')
    let result = -1;
    weapons.components.forEach(item => {
...
weapons.getGunSlotId = function(name) {
    methods.debug('weapons.getGunSlotId')
    switch (name) {
...
weapons.getGunAmmoId = function(name) {
    methods.debug('weapons.getGunAmmoId')
    switch (name) {
        case 'weapon_appistol':
        case 'weapon_assaultsmg':
        case 'weapon_advancedrifle':
