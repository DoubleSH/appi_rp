...
mp.events.add('7563747063743c6567756f68693c716e63636a3c626954696a6a', (player) => { //server:casino:wheel:doRoll
    methods.debug('7563747063743c6567756f68693c716e63636a3c626954696a6a')
    if (!user.isLogin(player))
        return;
    try {
        let userWin = 1;
...
mp.events.add('7563747063743c6567756f68693c716e63636a3c646a69656d', (player) => { //server:casino:wheel:block
    wheel.isBlock = true;
});

mp.events.add('7563747063743c6567756f68693c716e63636a3c7368646a69656d', (player) => { //server:casino:wheel:unblock
    wheel.isBlock = false;
});

mp.events.add('7563747063743c6567756f68693c716e63636a3c606f68676a54696a6a', (player) => { //server:casino:wheel:finalRoll
    methods.debug('7563747063743c6567756f68693c716e63636a3c606f68676a54696a6a')
    try {
