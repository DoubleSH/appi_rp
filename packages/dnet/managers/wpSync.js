 ...
 */
mp.Player.prototype.giveWeaponComponent = function (weaponHash, componentHash, wpNamed) {
    ...
    user.setWeaponComponened(this, wpNamed, componentHash)
 ...
 * @throws {TypeError} If any of the arguments is not a number.
 */
mp.Player.prototype.removeWeaponComponent = function (weaponHash, componentHash, wpNamed) {
    ...
    if (this.__weaponComponents.hasOwnProperty(weaponHash)) {
        user.deleteWeaponComponened(this, mp.joaat(wpNamed), componentHash)
